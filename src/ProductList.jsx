...
function ProductList({onHomeClick}) {
    ...
    const namesInCart = useMemo(() => new Set(cart.map((it) => it.name)), [cart]);
    ...
    return (
        <div className="product-page">
            ...
            <div className="navbar" style={{
                ...
                <div className="ul"
                     style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '1100px'}}>
                    <div><a href="#" onClick={handlePlantsClick}
                            style={{color: 'white', fontSize: '30px', textDecoration: 'none'}}>Plants</a></div>
                    ...
                    <div style={{position: 'relative'}}>
                        ...
                        {/* Dynamic count overlay */}
                        <span className="cart_quantity_count">{cartCount}</span>
                    </div>
                </div>
            </div>

            {/* Either Products grid or Cart view */}
            {!showCart ? (
                        ...
                        <div key={section.category} style={{width: '100%'}}>
                            ...
                            <div className="product-list">
                                {section.plants.map((plant) => {
                                    const added = namesInCart.has(plant.name);
                                    return (
